...
use `git clone https://github.com/{owner/repo.git}` to clone the repository into your folder
...
If you would like to have the code on your branch merged with the master, please submit a pull request on the git hub page https://github.com/{owner/repo}/pulls
